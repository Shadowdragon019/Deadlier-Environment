...
public class IronDaggerItem extends DeadlierEnvironmentModElements.ModElement {
	@ObjectHolder("deadlier_environment:iron_dagger")
	public static final Item block = null;
	public IronDaggerItem(DeadlierEnvironmentModElements instance) {
		super(instance, 9);
	}
