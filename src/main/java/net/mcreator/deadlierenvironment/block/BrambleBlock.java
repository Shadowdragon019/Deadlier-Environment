...
package net.mcreator.deadlierenvironment.block;
...
import net.mcreator.deadlierenvironment.procedures.BrambleMobplayerCollidesWithPlantProcedure;
...
public class BrambleBlock extends DeadlierEnvironmentModElements.ModElement {
	@ObjectHolder("deadlier_environment:bramble")
	public static final Block block = null;
	public BrambleBlock(DeadlierEnvironmentModElements instance) {
		super(instance, 1);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BrambleMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
