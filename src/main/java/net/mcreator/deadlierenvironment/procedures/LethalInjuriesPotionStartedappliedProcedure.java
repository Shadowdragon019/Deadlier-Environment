...
public class LethalInjuriesPotionStartedappliedProcedure extends DeadlierEnvironmentModElements.ModElement {
	public LethalInjuriesPotionStartedappliedProcedure(DeadlierEnvironmentModElements instance) {
		super(instance, 28);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure LethalInjuriesPotionStartedapplied!");
			return;
		}
